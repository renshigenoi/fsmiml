...
<head>
    ...
    <style>
        /* =========================================================
           ...
           Color palette inspired by Indo Motor Lestari logo:
           Navy  : #0b2044 / #112b5c / #1a3a7a
           Red   : #c8102e / #e01836 (accent)
        ========================================================= */
        :root {
            /* Navy palette */
            --navy-900: #061429;
        ...
        *, *::before, *::after { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .login-screen {
            ...
            color: var(--on-dark);
            padding: env(safe-area-inset-top, 44px) 24px 40px;
            position: relative;
            overflow: hidden;
        }
        .login-screen::before {
        ...
        .login-screen::after {
            ...
            border-radius: 50%;
            background: radial-gradient(circle, rgba(58,107,200,.15) 0%, transparent 70%);
        ...
        .login-logo-wrap {
            ...
            padding: 14px 20px;
            box-shadow: 0 8px 32px rgba(0,0,0,.28), 0 0 0 1px rgba(255,255,255,.15);
            margin-bottom: 24px;
        }
        .login-logo-wrap img { height: 52px; width: auto; display: block; }
        .login-screen h1 {
            font-size: 26px;
            font-weight: 800;
            letter-spacing: -.4px;
        ...
        .login-card input {
            ...
            color: var(--ink);
            outline: none;
            transition: border-color .2s var(--easef), box-shadow .2s var(--easef), background .2s;
        }
        ...
        .btn-login:active { transform: scale(.975); box-shadow: 0 2px 10px rgba(200,16,46,.25); }
        .btn-login:disabled { opacity: .6; transform: none; pointer-events: none; }
        .login-error {
        ...
        .header-title strong { display: block; font-size: 15px; font-weight: 800; line-height: 1.2; }
        .header-title span { font-size: 11.5px; color: var(--on-dark-2); }
        .icon-btn {
        ...
        .icon-btn:active { background: rgba(255,255,255,.22); transform: scale(.9); }
        ...
        .greet-band p { margin: 0; color: var(--on-dark-2); font-size: 13px; }
        ...
        .stat-card-icon { font-size: 22px; margin-bottom: 10px; display: block; }
        .stat-card .num {
            font-size: 30px;
            font-weight: 900;
            letter-spacing: -1px;
        ...
        .stat-card.s-red .num  { color: var(--red-500); }
        ...
        .s-red .stat-bar   { background: linear-gradient(90deg, var(--red-500), var(--red-300)); }
        .s-green .stat-bar { background: linear-gradient(90deg, var(--green), #34d399); }
        ...
        .wo-card:active { transform: scale(.982); box-shadow: var(--shadow); border-color: var(--navy-300); }
        .wo-card .row1 { display: flex; justify-content: space-between; align-items: center; gap: 8px; margin-bottom: 8px; }
        .wo-card .number { font-weight: 800; font-size: 14.5px; color: var(--navy-700); }
        .wo-card .cust { font-weight: 600; font-size: 14.5px; color: var(--ink); margin-bottom: 5px; }
        .wo-card .sub { font-size: 12.5px; color: var(--muted); display: flex; align-items: center; gap: 5px; flex-wrap: wrap; }
        ...
        .detail-head .d-num { font-size: 15.5px; font-weight: 800; }
        .detail-head .d-sub { font-size: 12px; color: var(--on-dark-2); margin-top: 1px; }
        .back-btn {
            background: var(--glass);
            border: 1px solid var(--glass-bdr);
            color: var(--on-dark);
        ...
        .back-btn:active { background: rgba(255,255,255,.22); transform: scale(.9); }
        ...
        .status-banner .s-label { font-size: 17px; font-weight: 800; letter-spacing: -.2px; }
        .status-banner .s-hint { opacity: .88; font-size: 12.5px; margin-top: 5px; line-height: 1.4; }
        ...
        .kv .k { color: var(--muted); flex-shrink: 0; font-size: 13.5px; }
        ...
        /* Map */
        #detail-map { height: 200px; border-radius: var(--r-sm); border: 1px solid var(--line); z-index: 1; overflow: hidden; }
        ...
        .step.active .lbl { color: var(--red-500); font-weight: 700; }
        .step::before {
            content: '';
            position: absolute;
            top: 13px; right: 50%;
        ...
        .action-btn:active { transform: scale(.975); box-shadow: var(--shadow-sm); }
        .action-btn:disabled { opacity: .55; pointer-events: none; }
        .action-btn.green  { background: linear-gradient(135deg,#10b981,#059669); box-shadow: 0 6px 18px rgba(5,150,105,.30); }
        .action-btn.red    { background: var(--red-grad); box-shadow: 0 6px 18px rgba(200,16,46,.30); }
        .action-btn.violet { background: linear-gradient(135deg,#8b5cf6,#6d28d9); box-shadow: 0 6px 18px rgba(109,40,217,.25); }
        .action-btn.blue   { background: linear-gradient(135deg,#0ea5e9,#0284c7); box-shadow: 0 6px 18px rgba(2,132,199,.25); }
        .action-btn.amber  { background: linear-gradient(135deg,#f59e0b,#d97706); box-shadow: 0 6px 18px rgba(217,119,6,.25); }
        .action-btn.ghost  { background: transparent; color: var(--red-500); border: 1.5px solid rgba(200,16,46,.25); box-shadow: none; }
        .action-btn.ghost:active { background: var(--red-100); }
        ...
        .gps-on  { background: var(--green-bg); color: #065f46; }
        .gps-off { background: var(--red-100);  color: var(--red-700); }
        .gps-live-note {
        ...
        .timeline li:last-child::before { background: var(--green); box-shadow: 0 0 0 3px var(--green-bg); }
        .timeline .tl-title { font-weight: 700; color: var(--ink-2); }
        .timeline .when { color: var(--muted); font-size: 12px; margin-top: 2px; }
        ...
        .alert-card.warning { background: #fffbeb; border: 1px solid #fde68a; color: #78350f; }
        .alert-card.danger  { background: var(--red-100); border: 1px solid var(--red-200); color: var(--red-700); }
        .alert-card .ai { font-size: 20px; flex-shrink: 0; line-height: 1.4; }
        .alert-card .at { font-size: 13px; line-height: 1.5; font-weight: 500; }
        ...
        .modal h3 { margin: 0 0 5px; font-size: 17px; font-weight: 800; color: var(--ink); }
        ...
        .chip.selected { border-color: var(--red-500); background: var(--red-100); color: var(--red-600); font-weight: 700; }
        .modal textarea {
            width: 100%;
            border: 1.5px solid var(--line);
            border-radius: var(--r-sm);
        ...
        .modal textarea:focus { border-color: var(--red-500); box-shadow: 0 0 0 3px rgba(200,16,46,.10); background: var(--surface); }
        .modal-actions { display: flex; gap: 10px; margin-top: 16px; }
        .modal-actions button {
            flex: 1; border: 0; border-radius: var(--r-sm);
            padding: 14px; font-size: 14.5px; font-weight: 700; font-family: inherit;
            cursor: pointer;
            transition: transform .12s, opacity .12s;
        }
        .modal-actions button:active { transform: scale(.975); }
        .modal-actions button:disabled { opacity: .55; }
        .modal-actions .cancel  { background: var(--bg); color: var(--muted); }
        .modal-actions .ok-red  { background: var(--red-grad); color: #fff; }
        .modal-actions .ok-green { background: linear-gradient(135deg,#10b981,#059669); color: #fff; }
        .mfield { display: block; font-size: 11.5px; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; color: var(--muted); margin: 14px 0 7px; }
        ...
        .modal input[type="password"]:focus { border-color: var(--red-500); box-shadow: 0 0 0 3px rgba(200,16,46,.10); background: var(--surface); }
        .modal-error {
            background: var(--red-100); color: var(--red-700);
            border: 1px solid var(--red-200); border-radius: var(--r-sm);
            padding: 10px 13px; font-size: 12.5px; font-weight: 500; margin-top: 12px;
        }
        ...
        /* =========================================================
           PAGE ANIMATION
        ========================================================= */
        .page-slide { animation: pg-slide .28s var(--ease); }
        @keyframes pg-slide {
        ...
        /* =========================================================
           SAFE AREA
        ========================================================= */
        .bottom-safe { height: max(env(safe-area-inset-bottom), 16px); }
    </style>
</head>
<body>
<div id="app" v-cloak>
    ...
    <div v-if="!token" class="login-screen">
        <div class="login-top">
            ...
            <h1>FSM Teknisi</h1>
            <p class="login-tagline">Sistem manajemen lapangan teknisi<br>Indo Motor Lestari 💪</p>
        </div>
        ...
        <div class="login-card">
            ...
            <div class="input-wrap">
                ...
                <input type="email" v-model.trim="loginForm.email"
                       placeholder="nama@indomotorlestari.co.id"
        ...
        <div class="login-foot">Indo Motor Lestari © 2026 · FSM v2</div>
    </div>
        ...
        <div v-if="view === 'home'">
            <div class="app-header">
                <div class="app-header-inner">
                    ...
                    <button class="icon-btn" @click="openPassModal" title="Ganti password" id="btn-pass">🔑</button>
                    <button class="icon-btn" @click="doLogout" title="Keluar" id="btn-logout">⎋</button>
                </div>
            </div>
            ...
            <div v-if="onTrip" class="gps-live-note" style="margin-top:14px;">
                <span class="pulse" style="color:#059669"></span>
                <span>Live tracking aktif — posisimu sedang dibagikan ke pelanggan. Biarkan aplikasi tetap terbuka!</span>
            </div>
            ...
            <template v-else>
                <div v-if="noTechnicianLink" class="section" style="margin-top:14px;">
                    <div class="alert-card danger">
                        ...
                        <span class="at">Akun ini belum terhubung ke data teknisi. Hubungi koordinator agar akunmu ditautkan.</span>
                    </div>
                </div>
                ...
                <div class="section" style="margin-top:14px;">
                    ...
                    <div v-if="pendingOrders.length === 0" class="empty">
                        <span class="big">🎉</span>
                        Tidak ada pekerjaan baru saat ini.<br>Santai sebentar, tugas akan segera datang!
                    </div>
                    <button v-for="wo in pendingOrders" :key="wo.id" class="wo-card" @click="openDetail(wo)" :id="'wo-' + wo.id">
                        <div class="row1">
                ...
                <div class="section">
                    ...
                    <button v-for="wo in activeOrders" :key="wo.id" class="wo-card" @click="openDetail(wo)" :id="'wo-active-' + wo.id">
                        <div class="row1">
                            <span class="number">{{ wo.number }}</span>
                        ...
                        <div class="sub">
                            ...
                            <span v-if="superseded(wo)" style="color:var(--muted)"> · Diambil teknisi lain</span>
                        </div>
                    </button>
                </div>
                ...
                <div class="section" v-if="historyOrders.length">
                    ...
                    <button v-for="wo in historyOrders" :key="wo.id" class="wo-card" @click="openDetail(wo)" :id="'wo-hist-' + wo.id" style="opacity:.85;">
                        <div class="row1">
                            <span class="number">{{ wo.number }}</span>
        ...
        <div v-else-if="view === 'detail' && current" class="page-slide">
            <div class="detail-head">
                <div class="detail-head-inner">
                    ...
                    <span class="badge" :class="statusBadge(current.status)">{{ statusLabel(current.status) }}</span>
                </div>
            </div>
            ...
            <div class="detail-body">
                ...
                <div class="card">
                    ...
                    <div class="kv" v-if="current.notes">
                        ...
                        <span class="v" style="text-align:left;font-weight:500;color:var(--ink-2);">{{ current.notes }}</span>
                    </div>
                    <div class="kv" v-if="current.items && current.items.length">
                        <span class="k">Item</span>
                        <span class="v" style="text-align:left;">{{ current.items.map(i => i.product_name).join(', ') }}</span>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div style="font-size:14px;font-weight:600;color:var(--ink-2);margin-bottom:12px;">
                ...
                <div class="card" v-if="actionList.length">
                    <h4>⚡ Aksi</h4>
                    <div class="actions">
                        <button v-for="act in actionList" :key="act.key"
                                class="action-btn" :class="act.cls"
                                :disabled="busy"
                                @click="runAction(act)"
                                :id="'act-' + act.key">
                            {{ act.label }}
                ...
                <div v-if="current.status === 'on_the_way'" class="card">
                    ...
                    <span class="gps-pill" :class="gpsState === 'active' ? 'gps-on' : 'gps-off'">
                        ...
                        {{ gpsState === 'active'
                            ...
                            : (gpsState === 'error' ? '⚠️ GPS bermasalah, cek izin lokasi' : '⌛ Menyiapkan GPS…') }}
                    </span>
                    <p class="muted small" style="margin:0;font-size:13px;line-height:1.5;">
                        Pelanggan bisa memantau posisimu lewat link tracking. Pastikan GPS HP menyala ya! 🙏
                    </p>
                </div>

                <!-- Superseded -->
                <div v-if="superseded(current)" class="alert-card warning">
                    <span class="ai">ℹ️</span>
                    <span class="at">Pekerjaan ini sudah diambil teknisi lain. Tenang, tugas baru akan segera datang! 💪</span>
                </div>
                ...
                <div class="card" v-if="current.status_histories && current.status_histories.length">
                    ...
                    <ul class="timeline">
                        <li v-for="h in current.status_histories" :key="h.id">
                            <div class="tl-title">{{ statusLabel(h.to_status) }}</div>
    ...
    <div v-if="passModal.show" class="modal-backdrop" @click.self="passModal.show = false">
        <div class="modal">
            ...
            <p class="desc">Password awal teknisi adalah <b>12345</b>. Segera ganti dengan password pribadimu!</p>
            ...
            <div v-if="passModal.error" class="modal-error">⚠️ {{ passModal.error }}</div>
            <div class="modal-actions">
...
<script>
    const STATUS_META = {
        ...
        finished:           { label: 'Selesai',              color: '#059669' },
    ...
    const app = Vue.createApp({
        ...
        computed: {
            ...
            noTechnicianLink() { return this.user && !this.user.technician_id; },
            onTrip() {
                return this.orders.some(wo =>
                    wo.status === 'on_the_way' && this.myAssignment(wo) && this.myAssignment(wo).status === 'accepted'
                );
            },
            steps() { return ['Diterima', 'Berangkat', 'Tiba', 'Pasang', 'Selesai']; },
            stepIndex() {
            ...
            bannerStyle() {
                ...
                const c = meta.color;
                return { background: `linear-gradient(135deg, ${c}ee, ${c}99)` };
            },
            statusHint() { return HINTS[this.current ? this.current.status : 'draft'] || ''; },
            actionList() {
        ...
        methods: {
            ...
            superseded(wo) { const a = this.myAssignment(wo); return a && a.status === 'superseded'; },
            ...
            async doLogin() {
                if (!this.loginForm.email || !this.loginForm.password) {
                    this.loginError = 'Email dan password wajib diisi.'; return;
                }
            ...
            async loadOrders(silent = false) {
                ...
                } catch (err) { if (!silent) this.showToast(err.message, 'error'); }
            ...
            async runAction(act) {
                ...
                if (act.key === 'finish') { if (!confirm('Yakin pekerjaan ini sudah selesai? 🙌')) return; }
                this.busy = true;
                try {
            ...
            async reloadDetail() {
                ...
                try {
                    ...
                    if (this.current.status === 'on_the_way') {
                        ...
                        this.startGps();
                    } else { this.tripSessionId = null; this.stopGps(); }
                    this.$nextTick(() => this.initMap());
                    await this.loadOrders(true);
                } catch (err) { this.showToast(err.message, 'error'); }
            },
            async syncTracking() {
                ...
                if (!trip) { this.tripSessionId = null; this.stopGps(); return; }
            ...
            startGps() {
                ...
                this.watchId = navigator.geolocation.watchPosition(
                    (pos) => { this.lastPos = pos; this.gpsState = 'active'; this.sendLocation(); },
                    () => { this.gpsState = 'error'; },
                    { enableHighAccuracy: true, maximumAge: 5000, timeout: 15000 },
                );
                this.gpsTimer = setInterval(() => { if (this.lastPos && this.onTrip) this.sendLocation(); }, 15000);
            },
            async sendLocation() {
            ...
            initMap() {
                ...
                if (this.lastPos && this.lastPos.coords) {
                    ...
                    this.mapPosMarker = L.circleMarker([c.latitude, c.longitude], {
                        radius: 8, color: '#c8102e', fillColor: '#c8102e', fillOpacity: .35,
                    }).addTo(this.mapInstance);
                }
            },
            destroyMap() {
                if (this.mapInstance) { this.mapInstance.remove(); this.mapInstance = null; }
                this.mapMarker = null; this.mapPosMarker = null;
            },
            forceLogout() {
                this.stopGps();
                this.token = ''; this.user = null; this.current = null; this.view = 'home';
            ...
            async submitPasswordChange() {
                ...
                this.busy = true; p.error = '';
                try {
                    await this.api('/auth/change-password', {
                        method: 'POST',
                        body: { current_password: p.current, new_password: p.next, new_password_confirmation: p.confirm },
                    });
                    p.show = false;
    ...
    app.config.errorHandler = (err) => { console.error('[FSM Mobile]', err); };
    app.mount('#app');
</script>
</body>
</html>
